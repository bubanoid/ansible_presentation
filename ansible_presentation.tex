...
\begin{itemize}
    ...
    \item для опису стану серверів використовується предметно-орієнтована мова програмування (англ. Domain-specific language, DSL) із yaml-синтаксисом
    ...
    \item для конфігурування віддаленої машини достатньо, щоб на ній був встановлений Python
    \item зв'язок із віддаленою машиною здійснюється по SSH протоколу
